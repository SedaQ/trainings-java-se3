...
@Api(value = "/meetings", 
  ...
  authorizations = {
    @Authorization(value = "sampleoauth", 
      scopes = {
        @AuthorizationScope(
          scope = "HTTP operations on Meeting Resource", 
          description = "allows operations on Meeting Resource."
        )
      }
    )
  }
...
public class MeetingRestController {
	  ...
	  @ApiOperation(httpMethod = "GET", 
	      value = "Get Meeting by Id.", 
	      response = MeetingDTO.class,
	      ...
	      authorizations = {
	          @Authorization(value = "sampleoauth", 
	              scopes = {
	                  @AuthorizationScope(
	                      scope = "find Meeting by ID", 
	                      description = "allows returning Meeting by ID."
	                  )
	              }
	          )
	      }
	  ...
	  //@formatter:off
	  @ApiOperation(httpMethod = "GET",
	      value = "Get All Meetings.",
	      response = MeetingDTO.class,
	      responseContainer = "Page",
	      nickname = "findAllMeetings",
	      produces = "application/json or application/xml",
	      authorizations = {
	          @Authorization(value = "sampleoauth", 
	              scopes = {
	                  @AuthorizationScope(
	                      scope = "find all Meetings", 
	                      description = "allows returning Meetings."
	                  )
	              }
	          )
	      }
	  ...
	  public ResponseEntity<Object> findAllMeetings(@QuerydslPredicate(root = Meeting.class) Predicate predicate, Pageable pageable,
